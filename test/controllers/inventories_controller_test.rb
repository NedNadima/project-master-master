...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { Description: @inventory.Description, Name: @inventory.Name, Price: @inventory.Price }
    end
  ...
  test "should update inventory" do
    patch :update, id: @inventory, inventory: { Description: @inventory.Description, Name: @inventory.Name, Price: @inventory.Price }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
